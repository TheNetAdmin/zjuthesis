...
\begin{center}
    \begin{tabularx}{.8\textwidth}{>{\songti\zihao{2}}l >{\songti\zihao{-2}}X<{\centering}}
        论文题目      &  \uline{\hfill} \\
    \end{tabularx}
\end{center}
...
\begin{center}
    ...
    \begin{tabularx}{.7\textwidth}{>{\songti}l >{\songti}X<{\centering}}
