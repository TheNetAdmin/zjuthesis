...
\documentclass[
    ...
    SubmitDate  = 递交日期,
    MajorFormat = general,
    Degree      = master,   % 'bachelor' or 'master'
    Type        = thesis,   % 'thesis'   or 'design' or 'equal'(only for master)
    Period      = final,    % 'proposal' or 'final'
    BlindReview = false,    % 'false'    or 'true'
    % Below only for 'master'
    Topic           = 研究方向,
...
\ifthenelse{\equal{\Degree}{bachelor}}
{
