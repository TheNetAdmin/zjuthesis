...
\documentclass[
    ...
    Major                   = 专业,
    % Department Info
    DepartmentInTwoLine     = true,             %   set it true if department name needs to be displayed in two lines.
    DepartmentLineOne       = 学院,             %   the department info here will always be displayed.
    DepartmentLineTwo       = 学院第二行,       %   the department info here will only be displayed if DepartmentInTwoLine set to true.
    SubmitDate              = 递交日期,
    MajorFormat             = general,
